...
PATIENT_CV_THRESHOLD_CSV = "../data/patient_diagnosis/patient_cv_summary_pca_only_opt_th.csv"
...
def main():
    ...
    out_df.to_csv(os.path.join(OUT_DIR, "patient_test_results_opt_th.csv"), index=False)
    print(f"\nSaved test results ? {OUT_DIR}/patient_test_results_opt_th.csv")
