...
# -------------------------
# 🚀 LOOP THROUGH METRICS FOLDER
# -------------------------
Config = '1'
#load csv thresholds
thresholds = f'optimal_thresholds_mse_red_Config{Config}.csv'
...
for csv_file in all_csvs:
    ...
    # Skip threshold CSV or already-generated predicted CSVs
