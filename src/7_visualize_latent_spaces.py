...
def visualize_latent_spaces(old_latents, new_latents, labels, title_suffix=""):
    ...
    old_latents: (N, D1) numpy array from AE encoder
    new_latents: (N, D2) numpy array from triplet embedder
...
y_train = np.load(latent_dir / "train_old_labels.npy")  # labels should be same for new_latents
